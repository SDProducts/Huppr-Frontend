                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 mt-3 leading-relaxed">
                            Get a real-time view of your talent pipeline with intelligent screening
                            and match scoring. Focus on the candidates that matter most.
                        </p>
                        ...
                        <div className="grid grid-cols-2 gap-4 mt-6">
                            ...
                            <div className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
                                ...
                                <div className="text-xs text-green-600">-1.5h from last month</div>
                            </div>
                        </div>
                        ...
                        <div className="mt-6 bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
                            <div className="flex items-center justify-between text-sm">
                                <span className="font-medium text-gray-700">Screening Progress</span>
                    ...
                    <div className="bg-white rounded-2xl border border-gray-200 shadow-lg overflow-hidden">
                        <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
                            <span className="font-semibold text-gray-900">Recent Applicants</span>
                        ...
                        <div className="divide-y divide-gray-100">
                            {[
                                { name: 'Emma Johnson', role: 'Senior Product Designer', location: 'New York, USA', match: 92, exp: '6+ years' },
                                { name: 'Cook Fischer', role: 'Frontend Engineer', location: 'Austin, TX', match: 88, exp: '4+ years' },
                                { name: 'Guy Hawkins', role: 'Marketing Manager', location: 'London, UK', match: 76, exp: '5+ years' },
                                { name: 'Sarah Jenkins', role: 'HR Operations Lead', location: 'San Francisco, CA', match: 94, exp: '8+ years' },
                            ].map((applicant, idx) => (
                                <div key={idx} className="px-5 py-3 flex items-center justify-between hover:bg-gray-50/50 transition">
                                    <div>
                                    ...
                                    <div className="text-right">
                                        <div className="text-sm font-semibold text-indigo-600">{applicant.match}%</div>
                        ...
                        <div className="px-5 py-3 bg-gray-50/50 border-t border-gray-100 flex items-center justify-between text-xs text-gray-500">
                            ...
                            <span className="text-indigo-600 font-medium">+12% this month</span>
                        </div>
                    </div>
                </div>
            </div>
