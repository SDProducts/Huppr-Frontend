...
const plans = [
    {
        ...
        features: ['3 Active Job Posts', 'Basic AI Screening', 'Unlimited Applicants'],
        cta: 'Get Started',
        highlight: false,
        icon: Rocket,
    },
                    ...
                    {plans.map((plan, idx) => (
                        ...
                        >
                            ...
                            <div className="mb-2">
                                ...
                                <span className="text-sm text-gray-500 ml-1.5">/{plan.period}</span>
                            </div>
                            <p className="text-sm text-gray-500 mb-6">{plan.description}</p>

                            <ul className="space-y-3 mb-8">
                                {plan.features.map((feature, fIdx) => (
                                    <li key={fIdx} className="flex items-center gap-2.5 text-sm text-gray-700">
