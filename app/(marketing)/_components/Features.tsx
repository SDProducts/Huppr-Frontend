    ...
    <section className="py-20 bg-white">
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-gray-600 mt-3 leading-relaxed">
            Transition seamlessly from hiring to managing. Our Pro tools provide
            everything needed to support your workforce as it expands.
          </p>
        </div>
        ...
        <div className="mt-12 text-center text-sm text-gray-500 bg-gray-50/50 rounded-2xl py-4 px-6 max-w-2xl mx-auto border border-gray-100">
          <span className="font-medium text-gray-700">
            Our intelligence doesn't replace humans; it empowers them.
          </span>
          <span className="block text-gray-500 mt-1">
            Making every hire a step toward a stronger, more inclusive culture.
          </span>
        </div>
      </div>
    </section>
