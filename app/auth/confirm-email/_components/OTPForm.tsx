        ...
        <Field>
          <div className="flex justify-center">
            <InputOTP maxLength={6} id="otp-verification" required>
              <InputOTPGroup className="*:data-[slot=input-otp-slot]:h-10 sm:*:data-[slot=input-otp-slot]:h-16 *:data-[slot=input-otp-slot]:w-10 sm:*:data-[slot=input-otp-slot]:w-16  *:data-[slot=input-otp-slot]:text-xl space-x-2">
